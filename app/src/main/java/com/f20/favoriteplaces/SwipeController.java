...
public class SwipeController extends Callback{
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
        ...
        //RectF editButton = new RectF(itemView.getRight() - buttonWidthWithoutPadding - corners, itemView.getTop(), itemView.getRight(), itemView.getBottom());
        p.setColor(Color.parseColor("#1ABC9C"));
